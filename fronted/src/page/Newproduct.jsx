...
function Newproduct() {
   const [data,setData] = useState({
    ...
    price : "",
    description : "",
    image : "",   // Base64 string for PREVIEW ONLY
    fileObject : null
  })
  ...
  const uploadImage = async(e)=>{
    ...
    ImagetoBase64(file).then(base64Image => {
      setData(preve => ({
            ...preve,
            image: base64Image,  // For the immediate visual preview
            fileObject: file     // For the final submission
        }));
    })    
  }
  ...
  const handleSubmit = async(e)=>{
    ...
    if(name && fileObject && category && price){
      ...
      const fetchData = await fetch(`${import.meta.env.VITE_API_URL}/upload`,{ //upload product is joint by bckend
        method : "POST",
        // headers : {
